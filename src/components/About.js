            ...
            <div className="about_content">
              <div className="row">
                <div className="about_text">
                  <h3>
                    저는 <span>협력을 중요하게 생각하는</span> 프론트엔드
                    개발자입니다.
                    <p>
                      저는 프론트엔드 개발에 높은 관심과 열정을 가지고 있습니다.
                      최근까지도 자바스크립트, 리액트, 타입스크립트 등과 같은
                      기술 스택을 사용하여 웹 사이트를 개발하였습니다. 제가 가장
                      강조하고 싶은 역량은 바로 협업 능력입니다. "새싹챗" 그리고
                      "새싹로그"라는 프로젝트를 진행하면서 팀원들과의 소통과
                      협업을 통해 문제를 해결해왔습니다. 이러한 경험이 저를 더
                      나은 개발자로 성장하게 해주었습니다.
                      <br />
                      <br />
                      이전에 다니던 회사에서는 유저 인터페이스 및 사용자 경험을
                      개선하기 위한 다양한 프로젝트를 수행하였습니다. 웹
                      사이트의 인터페이스를 디자인하고 개발하는 과정에서 제가
                      중점적으로 고려한 것은 바로 유저의 사용성과 편의성입니다.
                      이를 위해 다양한 UX/UI 디자인 패턴을 익혀 적용하였습니다.
                      <br />
